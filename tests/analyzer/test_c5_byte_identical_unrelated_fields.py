...
Invariants asserted
-------------------
1. base_hash == "980f488f4bb2" (R-1 closure value, post phase-2b; registered plugins excluded by R-4).
...
class TestBaseHashUnchanged:
    ...
    def test_base_hash_value(self):
        ...
        feature's dict-build from PIA → base shrank to 980f488f4bb2 (one-time
        fleet re-baseline; report content byte-identical).
