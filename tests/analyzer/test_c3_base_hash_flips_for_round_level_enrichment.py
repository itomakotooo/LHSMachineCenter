...
# byte-identical).
_EXPECTED_C3_BASE_HASH = "adf08191dd9c"  # Phase E: registered topdollar_choice feature → closure import add + parser.py TD session accumulator → base_hash 8a791a69cd05→adf08191dd9c; M15-only applicability; existing output additive-only
