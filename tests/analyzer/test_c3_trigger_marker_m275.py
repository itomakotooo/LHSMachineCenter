...
class TestM275TriggerMarkerAnalyzerRuns:
    ...
    def test_schema_version_is_2(self, m275_trigger_marker_summary):
        """SCHEMA_VERSION in produced summary context must be 2 (C3 code ran).
        ...
        assert rows_with_shape, (
            ...
            "SCHEMA_VERSION must be 2 (C3 active)."
        )
