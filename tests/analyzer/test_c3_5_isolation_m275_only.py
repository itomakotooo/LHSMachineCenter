...
This is the most important new test in C3.5. It asserts that:
  1. base_hash is the R-1 closure value (980f488f4bb2 as of phase-2b) — no
...
rather than pinning the literal hex value. The base_hash pin (980f488f4bb2 as of phase-2b)
...
Phase honesty-2 update (2026-05-29):
  ...
  PIA (a closure file) to 57fdb323585d, and phase-2b's bonus_chain_dynamics carve shrank
  PIA again so the current value is 980f488f4bb2. The isolation property is
...
2. base_hash == '980f488f4bb2' (R-1 closure value, post phase-2b; intentional pin).
...
class TestBaseHashUnchangedInC3_5:
    ...
    def test_base_hash_unchanged_from_c3(self):
        """base_hash must be the R-1 closure value (980f488f4bb2 as of phase-2b).
