...
# bba689d50f03 → d17c69c251ed.
_BASE_HASH_AT_HEAD = "d17c69c251ed"
...
class TestBaseHashConfigOnly:
    ...
    def test_base_hash_matches_head_snapshot(self):
        ...
        that drifted to d17c69c251ed at framework commit 58a28fd (parser.py edit),
        ...
        assert bh == _BASE_HASH_AT_HEAD, (
            ...
            f"by d17c69c251ed at framework commit 58a28fd — a parser.py change, not M155.)"
        )
