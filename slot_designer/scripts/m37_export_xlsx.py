...
def main():
    ...
    sd_strips = jload(_ROOT / 'slot_designer/machines/M37/reel_strips.json')['reels']
    ...
    for mode in [1, 2, 5, 7]:
        sd_w = jload(_ROOT / f'slot_designer/machines/M37/weights/mode_{mode}/weights.json')['weights']
