...
def _resolve_strips_path(weights_path: Path) -> Path:
    """Same convention as core loader: machines/<M>/reel_strips.json
    (Phase A layout — slot_designer/ARCHITECTURE.md §2)."""
    return weights_path.parent.parent.parent / "reel_strips.json"
