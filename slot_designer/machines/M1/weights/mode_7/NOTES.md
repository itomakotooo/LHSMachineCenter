...
strips = json.loads(Path('slot_designer/machines/M1/reel_strips.json').read_text(encoding='utf-8'))['reels']
m1 = json.loads(Path('slot_designer/machines/M1/weights/mode_1/weights.json').read_text(encoding='utf-8'))
m7_weights = []
for ri in range(3):
    reel = []
...
Path('slot_designer/machines/M1/weights/mode_7/weights.json').write_text(
