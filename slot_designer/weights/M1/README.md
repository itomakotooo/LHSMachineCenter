...
| 7 | 低 RTP turbulent | 84.82% | 10.37% | 6.36 | 19% / 66% / 14% | [mode_7/weights.json](mode_7/weights.json) |
...
| M1 mode 7 | 84.82% | **6.60%** | 低 RTP，mode 1 × (Cherry×0.5, Bar×0.9). Seven/Diamond marginals 完全跟随 mode 1 → Seven 占比随着总 RTP 缩水而升（用户 brief 原意）|
