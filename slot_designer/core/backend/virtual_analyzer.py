...
_ROOT = Path(__file__).resolve().parent.parent.parent.parent  # repo root (4 parents: file → backend → core → slot_designer → repo)
...
from slot_designer.core.emitter.chunk import compute_schema_fingerprint, emit_chunk, write_chunk
