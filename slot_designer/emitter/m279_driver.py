...
from ..engine.m279.engine import M279SessionState, M279SpinEngine
from .chunk import emit_chunk
...
def compute_m279_schema_fingerprint(
    ...
    *,
    ...
    """
    from .chunk import compute_schema_fingerprint
    from ..engine.m279.engine import M279SessionState
