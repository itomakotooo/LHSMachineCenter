...
# ----------------------------------------------------------------------
# Pure utility functions needed by parse_chunk_response.
# Copied from player_impact_analyzer.py (P2-B1b).  PIA retains its own
# definitions for backward compat; these copies are identical so callers
# that imported via PIA are unaffected. Cycle freedom is preserved: this
# module does NOT import from player_impact_analyzer.
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Bankruptcy simulation helpers needed by parse_chunk_response.
# Copied from player_impact_analyzer.py (P2-B1b).  PIA retains its own
# definitions; these copies are identical.
# ----------------------------------------------------------------------
