...
Reads SLOT_E2E_STATE_DIR / SLOT_E2E_REPORTS / SLOT_E2E_CACHE from the
environment and constructs an isolated FastAPI app via create_app. This
keeps the env-var coupling out of production app.py and main.py while
still letting Playwright fixtures spawn ``python -m uvicorn`` against
tmp paths.
