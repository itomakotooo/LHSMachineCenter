...
const I18N = {
  zh: {
    ...
    stoTitle: "各 SpinType 分析",
    stoShare: "占比",
    stoSelfRtp: "本类 RTP",
    stoFeature: "玩法(feature)",
    stoFeatureRtp: "feature RTP(pp)",
    stoColShare: "占比",
    stoBandsRoundNote: "按回合(每转总赢÷押注,占比=占全部付费转)",
    stoBandsPaylineNote: "按中奖线(旧报告近似;重生成后按回合)",
    stoSettlementTitle: "结算分布(本 SpinType 出钱)",
    stoBandsTitle: "产出分布(倍数区间)",
    stoPayidTitle: "中奖明细(payid · 符号组合 · 覆盖列)",
    stoBehaviorTitle: "玩家选择行为",
    stoHit: "命中率",
    stoDead: "空转率",
    stoAvgWin: "命中均赢",
    stoRtpPp: "RTP 贡献(pp)",
    ...
    stoColMult: "倍数",
    stoColCols: "覆盖列",
    stoNoPayouts: "此 SpinType 无中奖线产出 —— 它的赢分计入触发它的回合（结算细节见上方 TopDollar 玩家选择面板）。",
    stoRoundStatsNA: "（该 SpinType 未在回合统计中出现，回合级数据不可用）",
    ...
    labelUseLocalMachineConfig: "本次采样使用此 config",
    labelTestConfig: "测试 Config",
    btnUploadConfig: "上传/替换",
    btnClearConfig: "清除",
    serverDefault: "默认",
    btnSetDefault: "设为默认",
    reportCleanupConfirm: "清理已被当前版取代的 analyzer 过期旧报表版本：仅当该 机台+mode 已有当前版报表时,才删它下面的过期旧版本;没有当前版报表的机台只去重,绝不清空其唯一报表。确定？",
    ...
    // ── P2: TopDollar Choice panel (topdollar_choice feature, M15 family) ──
    tdChoiceTitle: "TopDollar 玩家选择（ST=14）",
    tdTotalSessions: "触发局数",
    tdTriggerRate: "触发率",
    tdStoppedEarly: "见好就收率",
    tdForced4th: "被逼到第4抽率",
    tdForced4thCount: "被逼第4抽次数",
    tdBadGamble: "越赌越亏率",
    tdBadGambleCount: "越赌越亏次数",
    tdSettledMedian: "结算中位数（credits）",
    tdSettledMax: "结算最大值（credits）",
    tdRtpContribution: "占总 RTP（pp）",
    tdPicksPerSession: "每局抽取次数分布",
    tdDollarTiers: "面额分布（credits）",
    tdChosenCombos: "一次抽取的面额组合",
    tdTotalMultMedian: "总倍率中位数",
    tdTotalMultMax: "总倍率最大",
    tdTotalMultDist: "小游戏总倍率分布",
    tdColKey: "项",
    tdColCount: "次数",
    tdColPicks: "抽取次数",
    tdColSessions: "局数",
    ...
    tdColCombo: "面额组合",
    // ── Respin dynamics (M43 ST50) ──
    panelRespinDynamics: "Respin 动态",
    rdGrantRate: "触发率",
    rdGrantRatePerWin: "每次赢钱付费转触发率",
    rdGrantRatePerSpin: "每次付费转触发率",
    rdGrantRateOnePerN: "平均每 N 次付费转触发",
    rdGrantOpeners: "触发次数",
    rdHitRateUplift: "命中率提升",
    rdRespinHitRate: "Respin 命中率",
    rdBaseHitRate: "基础命中率",
    rdUpliftRatio: "提升倍率",
    rdMultDist: "倍率分布",
    rdRespinMultDist: "Respin 倍率分布",
    rdBaseMultDist: "基础倍率分布",
    rdColBand: "倍率段",
    rdColProb: "出现率",
    rdColWinShare: "赢钱占比",
    rdTailGe20: "≥20x 赢钱占比",
    rdPayidMix: "PayID 组合对比（Respin vs 基础）",
    rdPayidNote: "说明",
    rdColPayid: "Pay ID",
    rdColHitShare: "命中占比",
    rdContinuity: "连续性",
    rdContinuationProb: "继续概率",
    rdRespinToRespin: "Respin→Respin 次数",
    rdExitTotal: "退出次数",
    rdExitBreakdown: "退出目标分布",
    rdParserBlind: "待 per-ST 提取层",
    rdRtpConcentration: "RTP 集中度",
    rdRtpContrib: "Respin RTP 贡献（pp）",
    rdShareOfWin: "赢钱总占比",
    rdFatTailShare: "≥20x 赢钱占比（肥尾）",
    rdLossRate: "无赢钱率",
    // ── Lock-respin dynamics (M104 ST96 in-line LockSymbolSpin hold-and-respin) ──
    panelLockRespinDynamics: "锁定重转动态 (Lock)",
    lrGrantRate: "锁定触发率",
    lrLockRecords: "锁定记录数",
    lrRecordRate: "每次付费转锁定记录率",
    lrOnePerN: "平均每 N 次付费转锁定（按记录）",
    lrDeterminism: "35x ⟺ 锁定 确定性",
    lrTriggerSymbol: "触发符号",
    lrPLockGivenTrig: "P(锁定 | 触发符号)",
    lrPLockGivenNoTrig: "P(锁定 | 无触发符号)",
    lrMultDist: "倍率分布（ST 段）",
    lrLockWinShareSt: "锁定记录赢钱占该 ST 比",
    lrParserBlind: "待 per-ST 提取层（链长阶梯 / 倍率野阶梯）",
    // ── Minigame dynamics (M43 ST51) ──
    panelMinigameDynamics: "小游戏动态",
    mgMultDist: "倍率分布",
    mgColBand: "倍率段",
    mgColCount: "次数",
    mgColProb: "出现率",
    mgColWinShare: "赢钱占比",
    mgModalBand: "众数段",
    mgDominantShare: "众数段占比",
    mgTriggerFreq: "触发频率",
    mgEvents: "小游戏次数",
    mgPerPaidSpin: "每次付费转触发率",
    mgOnePerN: "平均每 N 次付费转触发",
    mgTriggerContext: "触发上下文",
    mgFromBase: "从基础转触发",
    mgFromRespin: "从 Respin 触发",
    mgShareFromBase: "基础转触发占比",
    mgShareFromRespin: "Respin 触发占比",
    mgNodePath: "路径分析",
    mgNodePathNA: "路径数据暂不可用",
    mgParserBlind: "待 per-ST 提取层",
    mgRtpConcentration: "RTP 集中度",
    mgRtpContrib: "小游戏 RTP 贡献（pp）",
    mgShareOfWin: "赢钱总占比",
    ...
    wdCellGrid: "转盘格子（CellIndex → 奖项）",
    wdColCell: "格子",
    wdColHitCount: "落点次数",
    wdColHitRate: "落点率",
    wdUnobserved: "未观测",
    wdUnobservedNote: "样本内未落到的格子，奖项不臆造（更多转盘可定其值）",
    wdObservedCells: "已观测格数",
    wdNondetAlarm: "数据告警：有格子落到 >1 种倍率（每格应确定），其倍率标空，请排查",
    // ── Nudge dynamics (M63 ST1 crazy-reel nudge) ──
    panelNudgeDynamics: "移轴动态 (Crazy 移轴)",
    ndCadence: "移轴节奏",
    ndHitRate: "移轴命中率（占付费转）",
    ndNudgeRounds: "移轴次数",
    ndSingleColShare: "单轴占比",
    ndOnePerN: "平均每 N 次付费转移轴",
    ndUplift: "赢率提升 · 移轴致胜",
    ndNudgeWinRate: "移轴赢率",
    ndBaselineWinRate: "基础赢率",
    ndUpliftRatio: "提升倍数",
    ndWinThrough: "经移轴致胜占比",
    ndSlideDist: "滑动落位分布（移轴落点）",
    ndColArrangement: "排列（上-中-下）",
    ndColCount: "次数",
    ndColDist: "各轴分布（任意轴可移）",
    ndColReel: "卷轴",
    ndColShare: "占比",
    ndReelLabel: "卷轴",
    ndRtpContrib: "移轴 RTP 贡献（pp）",
    // ── Freespin dynamics (M275 ST126) ──
    panelFreespinDynamics: "免费旋转动态 (Freespin)",
    fsCadence: "授予节奏",
    fsOpeners: "授予次数（连续区块）",
    fsAvgBlockLen: "平均区块长度（轮）",
    fsChainCount: "链数",
    fsAvgChainLen: "平均链长",
    fsRetriggersPerChain: "平均每链再触发",
    fsFreespinHitRate: "Freespin 命中率",
    fsFreespinMultDist: "Freespin 倍率分布",
    fsPayidMix: "PayID 组合对比（Freespin vs 基础）",
    fsTriggerPaths: "触发路径对比（并排）",
    fsTotalSessions: "总会话数",
    fsColMetric: "指标",
    fsColPath: "路径",
    fsRowSessions: "会话数",
    fsRowSessionShare: "会话占比",
    fsRowTriggerRate: "每次付费转触发率",
    fsRowOnePerN: "平均每 N 次付费转",
    fsRowRounds: "轮数",
    fsRowWinShare: "赢钱占比",
    fsRowRtpPp: "RTP 贡献（pp）",
    fsPathBands: "各路径倍率分布",
    fsUnknownPaths: "未知触发路径（信号，需排查）",
    fsMultiBuckets: "多重触发合并桶",
    fsRtpContrib: "Freespin RTP 贡献（pp）",
    // ── Phase 3: ER ladder / FS arc / session tier (freespin_progression) ──
    fsErLadder: "ExtraRatio 阶梯（逐轮倍率爬升）",
    fsErLadderNote: "每个 Freespin 位置的 ER 均值（单调递增）；按触发路径分列",
    fsErColFsIdx: "FS 序号",
    fsErColMeanEr: "平均 ER",
    fsErColRounds: "轮数",
    fsErColErDist: "ER 分布（top）",
    fsFsArc: "FS 序号命中率弧线（命中悬崖）",
    fsFsArcNote: "皮肤切换驱动的命中率下降：FS 1-3 皮肤 11 ~41% → FS 8-10 皮肤 31 ~4.7%",
    fsFsColIdx: "FS 序号",
    fsFsColHitRate: "命中率",
    fsFsColMeanWin: "赢钱均值（命中时）",
    fsFsColRounds: "轮数",
    fsSessionTier: "会话级别分布（每会话总赢/下注）",
    fsSessionTierTotal: "总会话数",
    fsProgAggregate: "合计",
    fsSessionColBand: "倍率区间",
    fsSessionColSessions: "会话数",
    fsSessionColProb: "概率",
    ...
    sdStatusWarn: "结构契约警告",
    sdStatusFail: "结构契约失败",
    sdStatusUnaudited: "结构契约未审核",
    sdUndeclaredSts: "未声明 SpinType（数据中存在但 manifest 未声明）",
    sdDeclaredAbsent: "已声明 SpinType 但样本中未出现（信息性，可能是样本量不足）",
    sdPerStDrift: "各 SpinType 字段漂移明细",
    sdMissingDeclaredFields: "缺失已声明字段",
    sdNewUndeclaredFields: "新增未声明字段",
    sdObservedAbsent: "本次未出现的已知字段（仅供参考，可选字段出现率随配置/皮肤变化）",
    sdUnauditedFields: "该 SpinType 未声明 observed_fields —— 无法审核新增字段（仅签名字段已审核）",
    sdAuditedRounds: "已审核轮次",
    sdColSt: "SpinType",
    sdColRounds: "轮次",
    sdColShare: "占比",
    sdColField: "字段",
    ...
    sdReason: "原因",
    sdSource: "来源",
    sdNoUndeclaredSts: "无未声明 SpinType",
    sdNoDrift: "各 SpinType 字段均与声明一致",
  },
  en: {
    ...
    stoTitle: "Per-SpinType Analysis",
    stoShare: "Share",
    stoSelfRtp: "Self RTP",
    stoFeature: "Feature",
    stoFeatureRtp: "feature RTP(pp)",
    stoColShare: "Share",
    stoBandsRoundNote: "per round (spin total win÷bet; share = of all paid spins)",
    stoBandsPaylineNote: "per payline (old-report approximation; round-level after regen)",
    stoSettlementTitle: "Settlement distribution (this SpinType pays out)",
    stoBandsTitle: "Outcome distribution (mult bands)",
    stoPayidTitle: "Payouts (payid · symbol combo · covered cols)",
    stoBehaviorTitle: "Player-choice behavior",
    stoHit: "Hit rate",
    stoDead: "Dead-spin rate",
    stoAvgWin: "Avg win/hit",
    stoRtpPp: "RTP contrib (pp)",
    stoMaxMult: "Max mult",
    stoSmall: "Small (<5×)",
    stoBig: "Big (≥20×)",
    stoColBand: "Mult band",
    stoColHits: "Hits",
    stoColRtp: "RTP(pp)",
    stoColCombo: "Symbol combo",
    stoColMult: "Mult",
    stoColCols: "Cols",
    stoNoPayouts: "This SpinType has no payline payouts — its winnings are booked to the round that triggered it (see the TopDollar player-choice panel above for settlement detail).",
    stoRoundStatsNA: "(This SpinType is absent from the round breakdown; round-level stats unavailable.)",
    ...
    labelUseLocalMachineConfig: "Use this config for sampling",
    labelTestConfig: "Test Config",
    btnUploadConfig: "Upload / Replace",
    btnClearConfig: "Clear",
    serverDefault: "Default",
    btnSetDefault: "Set default",
    reportCleanupConfirm: "Prune analyzer-stale older report versions superseded by a current report — only where a current report survives; machine-modes without one are de-duplicated only, never emptied. Continue?",
    ...
    payIdRtpCol: "RTP (pp)",
    payIdShapeCol: "Shape (inf.)",
    payIdColsCol: "Cols (inf.)",
    payIdLineCol: "Line",
    payIdNotesCol: "Notes",
    payIdCatPaid: "Paid",
    payIdCatBonus: "Bonus",
    ...
    colSymbolCombo: "Symbol combo",
    colCoveredCols: "Covered cols",
    ...
    // ── P2: TopDollar Choice panel (topdollar_choice feature, M15 family) ──
    tdChoiceTitle: "TopDollar Player Choice (ST=14)",
    tdTotalSessions: "Sessions triggered",
    tdTriggerRate: "Trigger rate",
    tdStoppedEarly: "Stopped early rate",
    tdForced4th: "Forced to 4th pick rate",
    tdForced4thCount: "Forced to 4th pick count",
    tdBadGamble: "Bad gamble rate",
    tdBadGambleCount: "Bad gamble count",
    tdSettledMedian: "Settled win median (credits)",
    tdSettledMax: "Settled win max (credits)",
    ...
    tdTotalMultMedian: "Total mult median",
    tdTotalMultMax: "Total mult max",
    tdTotalMultDist: "Mini-game total multiplier distribution",
    tdColKey: "Key",
    tdColCount: "Count",
    tdColPicks: "Picks",
    ...
    // ── Respin dynamics (M43 ST50) ──
    panelRespinDynamics: "Respin Dynamics",
    rdGrantRate: "Grant Rate",
    rdGrantRatePerWin: "Per winning paid spin",
    rdGrantRatePerSpin: "Per paid spin",
    rdGrantRateOnePerN: "One per N paid spins",
    rdGrantOpeners: "Opener count",
    rdHitRateUplift: "Hit-rate uplift",
    rdRespinHitRate: "Respin hit rate",
    rdBaseHitRate: "Base hit rate",
    rdUpliftRatio: "Uplift ratio",
    rdMultDist: "Multiplier distribution",
    rdRespinMultDist: "Respin multiplier distribution",
    rdBaseMultDist: "Base multiplier distribution",
    rdColBand: "Band",
    rdColProb: "Prob",
    rdColWinShare: "Win share",
    rdTailGe20: "≥20x win share",
    rdPayidMix: "PayID mix: Respin vs Base",
    rdPayidNote: "Note",
    rdColPayid: "Pay ID",
    rdColHitShare: "Hit share",
    rdContinuity: "Continuity",
    rdContinuationProb: "Continuation prob",
    rdRespinToRespin: "Respin→Respin count",
    rdExitTotal: "Exit count",
    rdExitBreakdown: "Exit target breakdown",
    rdParserBlind: "Pending per-ST extraction layer",
    rdRtpConcentration: "RTP concentration",
    rdRtpContrib: "Respin RTP contribution (pp)",
    rdShareOfWin: "Share of all win",
    rdFatTailShare: "≥20x win share (fat tail)",
    rdLossRate: "Zero-win rate",
    // ── Lock-respin dynamics (M104 ST96 in-line LockSymbolSpin hold-and-respin) ──
    panelLockRespinDynamics: "Lock-Respin Dynamics",
    lrGrantRate: "Lock grant rate",
    lrLockRecords: "Lock records",
    lrRecordRate: "Lock-record rate per paid spin",
    lrOnePerN: "One per N paid spins (by record)",
    lrDeterminism: "35x ⟺ Lock determinism",
    lrTriggerSymbol: "Trigger symbol",
    lrPLockGivenTrig: "P(Lock | trigger symbol)",
    lrPLockGivenNoTrig: "P(Lock | no trigger symbol)",
    lrMultDist: "Multiplier distribution (ST band)",
    lrLockWinShareSt: "Lock-record win share of ST",
    lrParserBlind: "Pending per-ST extraction layer (chain-length / wild ladder)",
    // ── Minigame dynamics (M43 ST51) ──
    panelMinigameDynamics: "Minigame Dynamics",
    mgMultDist: "Multiplier distribution",
    mgColBand: "Band",
    mgColCount: "Count",
    mgColProb: "Prob",
    mgColWinShare: "Win share",
    mgModalBand: "Modal band",
    mgDominantShare: "Modal band share",
    mgTriggerFreq: "Trigger frequency",
    mgEvents: "Minigame events",
    mgPerPaidSpin: "Per paid spin",
    mgOnePerN: "One per N paid spins",
    mgTriggerContext: "Trigger context",
    mgFromBase: "From base spin",
    mgFromRespin: "From respin burst",
    mgShareFromBase: "Share from base spin",
    mgShareFromRespin: "Share from respin",
    mgNodePath: "Node path analysis",
    mgNodePathNA: "Node data not yet available",
    mgParserBlind: "Pending per-ST extraction layer",
    mgRtpConcentration: "RTP concentration",
    mgRtpContrib: "Minigame RTP contribution (pp)",
    ...
    wdCellMap: "Wheel · jackpot",
    wdCells: "Wheel cells",
    wdJackpotCells: "Jackpot cell(s)",
    wdJackpotPrize: "Jackpot ×",
    wdRtpContrib: "Wheel RTP contribution (pp)",
    wdCellGrid: "Wheel cells (CellIndex → prize)",
    wdColCell: "Cell",
    wdColHitCount: "Landings",
    wdColHitRate: "Land rate",
    wdUnobserved: "unobserved",
    wdUnobservedNote: "cells with no landing in this sample — prize not fabricated (more spins would pin it)",
    wdObservedCells: "Observed cells",
    wdNondetAlarm: "DATA ALARM: a cell paid >1 distinct multiplier (each cell should be deterministic); its prize is null — investigate",
    // ── Nudge dynamics (M63 ST1 crazy-reel nudge) ──
    panelNudgeDynamics: "Reel Nudge Dynamics (Crazy)",
    ndCadence: "Nudge cadence",
    ndHitRate: "Nudge hit-rate (of paid spins)",
    ndNudgeRounds: "Nudge rounds",
    ndSingleColShare: "Single-reel share",
    ndOnePerN: "One per N paid spins",
    ndUplift: "Win-rate uplift · win-through-nudge",
    ndNudgeWinRate: "Nudge win-rate",
    ndBaselineWinRate: "Baseline win-rate",
    ndUpliftRatio: "Uplift ratio",
    ndWinThrough: "Win-through-nudge share",
    ndSlideDist: "Slide-offset distribution (nudge landing)",
    ndColArrangement: "Arrangement (top-mid-bot)",
    ndColCount: "Count",
    ndColDist: "Per-reel distribution (any reel can nudge)",
    ndColReel: "Reel",
    ndColShare: "Share",
    ndReelLabel: "Reel",
    ndRtpContrib: "Nudge RTP contribution (pp)",
    // ── Freespin dynamics (M275 ST126) ──
    panelFreespinDynamics: "Freespin Dynamics",
    fsCadence: "Grant cadence",
    fsOpeners: "Grant count (contiguous blocks)",
    fsAvgBlockLen: "Avg block length (rounds)",
    fsChainCount: "Chain count",
    fsAvgChainLen: "Avg chain length",
    fsRetriggersPerChain: "Avg retriggers per chain",
    fsFreespinHitRate: "Freespin hit rate",
    fsFreespinMultDist: "Freespin multiplier distribution",
    fsPayidMix: "PayID mix: Freespin vs Base",
    fsTriggerPaths: "Trigger paths (side-by-side)",
    fsTotalSessions: "Total sessions",
    fsColMetric: "Metric",
    fsColPath: "Path",
    fsRowSessions: "Sessions",
    fsRowSessionShare: "Session share",
    fsRowTriggerRate: "Trigger rate per paid spin",
    fsRowOnePerN: "One per N paid spins",
    fsRowRounds: "Rounds",
    fsRowWinShare: "Win share",
    fsRowRtpPp: "RTP contribution (pp)",
    fsPathBands: "Per-path multiplier bands",
    ...
    // ── Phase 3: ER ladder / FS arc / session tier (freespin_progression) ──
    fsErLadder: "ExtraRatio Ladder (per-spin ER climb)",
    fsErLadderNote: "Mean ER per FS position (monotone increasing); split by trigger path",
    fsErColFsIdx: "FS index",
    fsErColMeanEr: "Mean ER",
    fsErColRounds: "Rounds",
    fsErColErDist: "ER distribution (top)",
    fsFsArc: "FS-index Hit-Rate Arc (the cliff)",
    fsFsArcNote: "Skin-change drives hit-rate decline: FS 1-3 skin 11 ~41% → FS 8-10 skin 31 ~4.7%",
    fsFsColIdx: "FS index",
    fsFsColHitRate: "Hit rate",
    fsFsColMeanWin: "Mean win when hit",
    fsFsColRounds: "Rounds",
    fsSessionTier: "Session-tier distribution (session win / bet)",
    fsSessionTierTotal: "Total sessions",
    fsProgAggregate: "Aggregate",
    fsSessionColBand: "Band",
    fsSessionColSessions: "Sessions",
    fsSessionColProb: "Prob",
    // ── Dimension by_dim side-by-side (Phase 2) ──
    dimColMetric: "Metric",
    ...
    sdStatusWarn: "Structure contract WARN",
    sdStatusFail: "Structure contract FAIL",
    sdStatusUnaudited: "Structure contract unaudited",
    sdUndeclaredSts: "Undeclared SpinTypes (in data but not in manifest)",
    sdDeclaredAbsent: "Declared SpinTypes absent from sample (informational — may be sample-size)",
    sdPerStDrift: "Per-SpinType field drift detail",
    sdMissingDeclaredFields: "Missing declared fields",
    sdNewUndeclaredFields: "New undeclared fields",
    sdObservedAbsent: "Known fields absent this run (informational — optional-field rate varies by config/skin)",
    sdUnauditedFields: "This SpinType declares no observed_fields — new-field audit cannot run (signature fields audited only)",
    sdAuditedRounds: "Audited rounds",
    sdColSt: "SpinType",
    sdColRounds: "Rounds",
    sdColShare: "Share",
    sdColField: "Field",
    sdColPresence: "Presence",
    sdReason: "Reason",
    sdSource: "Source",
    sdNoUndeclaredSts: "No undeclared SpinTypes",
    sdNoDrift: "All SpinType fields match declarations",
  },
};
