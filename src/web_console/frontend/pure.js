...
const I18N = {
  zh: {
    ...
    labelMachineConfigOverride: "临时配置覆盖 (MachineConfig)",
    hintMachineConfigOverride: "上传 JSON 会在下次「开始采样」时随每个 upstream 请求发出，仅作用于当前聚焦机台、不持久化",
    btnPickMachineConfig: "选择 JSON 文件",
    btnClearMachineConfig: "清除",
  ...
  en: {
    ...
    labelMachineConfigOverride: "Temporary config override (MachineConfig)",
    hintMachineConfigOverride: "Uploaded JSON is sent with every upstream request on the next \"Start Sampling\" — scoped to the focused machine only, never persisted",
    btnPickMachineConfig: "Pick JSON file",
    btnClearMachineConfig: "Clear",
