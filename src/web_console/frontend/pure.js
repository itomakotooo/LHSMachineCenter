...
const I18N = {
  zh: {
    ...
    thProbPct: "出现率",
    stSplitPayIdCol: "Pay ID",
    stSplitHitCountCol: "命中次数",
    stSplitHitRateCol: "命中率",
    stSplitTotalWinCol: "总 Win",
    stSplitAvgWinCol: "命中均赢",
    stSplitRtpPpCol: "RTP (pp)",
    reelColPrefix: "列",
  },
  en: {
    ...
    thProbPct: "Prob %",
    stSplitPayIdCol: "Pay ID",
    stSplitHitCountCol: "Hit Count",
    stSplitHitRateCol: "Hit Rate",
    stSplitTotalWinCol: "Total Win",
    stSplitAvgWinCol: "Avg Win when Hit",
    stSplitRtpPpCol: "RTP (pp)",
    reelColPrefix: "Col",
  },
};
